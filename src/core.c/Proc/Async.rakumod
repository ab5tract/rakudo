...
#?if !jvm
        ...
        my int $dones-expected = std eq 'merge' ?? 2 !! 1;
#?endif
#?if jvm
        # The JVM merges the two streams into one pipe before we ever read
        # it, so even a merged stream ends after a single report.
        my int $dones-expected = 1;
#?endif
