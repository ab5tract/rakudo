  ...
  is RakuAST::Package::Attachable
{
    ...
    has int $.is-parameterization-generic;
    ...
    method replace-body(RakuAST::Code $role-body, RakuAST::Signature $signature) {
        ...
        my $ok := self.determine-generic-parameterization;
        nqp::bindattr_i(self,RakuAST::Role,'$!is-parameterization-generic',$ok);
        Nil
    }
    ...
    method determine-generic-parameterization() {
        nqp::say("signature: " ~ self.parameterization.raku) if nqp::getenvhash<WTF> > 1;
        1
    }
  ...
  is RakuAST::Package::Attachable
{
    ...
    method PERFORM-BEGIN(RakuAST::Resolver $resolver, RakuAST::IMPL::QASTContext $context) {
        my $body := nqp::getattr(self,RakuAST::Package,'$!body');
        $body.to-begin-time($resolver, $context); # In case it's the default generated by replace-body
        ...
        # Apply any traits
        self.apply-traits($resolver, $context, self);
#        nqp::findmethod(self,'PERFORM-BEGIN')(self,$resolver,$context);
